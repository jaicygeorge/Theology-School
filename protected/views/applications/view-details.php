        ...
        <?php if($attachments) { ?>
            <tr>
                ...
                <td class="label-details">
                    ...
                    <a href="/applications/download/file/<?php echo $attachment->id;?>"><img src="/<?php echo Yii::app()->params['ApplicationFilePath'].$attachment->attachment;?>" height="100px" width="100px"/></a><br/>              
                    <?php } } ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="label-details">
                    ...
                    <a href="/applications/download/file/<?php echo $attachment->id;?>"><?php echo $attachment->original_name;?></a><br/><br/>                
                    <?php } } ?>
                </td>
            </tr>
