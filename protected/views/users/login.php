	...
	$('#loginform').validate(
		{
			...
			if (errors) {
				...
				$("div.errorSummary").html('<?php echo Yii::t('app', 'Invalid Login Details'); ?>'); 
			} 
			else {
...
<div id="signin">	
  ...
  <div class="errorSummary" <?php if (!$form->hasErrors()) echo 'style="display:none;"'; ?>>
  	<?php if ($form->hasErrors()) {
  			echo Yii::t('app', 'Invalid Login Details');
  		}
...
//                var_dump($form);exit;
  ...
  <div class="box-content">    
    <form style="" action="" id="loginform" method="post"><div style="margin: 0pt; padding: 0pt;"></div>
    	<dl>
			<dt><label for="email">Username</label></dt>
			<dd><input class="required" value="" id="email" name="LoginForm[email]" value="<?php echo $form->email; ?>" tabindex="6" type="text"></dd>
			<dt><label for="password"><?php echo Yii::t('app', 'password'); ?></label> 
<!--                            <a href="#" id="reset-password-link">(<?php echo Yii::t('app', 'Forgot Password'); ?>)</a>-->
                        </dt>
		...
		<p class="btns">
                    <input class="submit" value="<?php echo Yii::t('app', 'Login');?>" tabindex="9" type="submit">
                        <input class="reset" value="<?php echo Yii::t('app', 'Reset');?>" tabindex="10" type="reset"></p>
                        <div class="clear"></div>
	</form>
    
    <form style="overflow: visible; margin-top: 10px;display: none;" action="<?php echo $this->createUrl('/users/pwdreset'); ?>" id="reset-password" method="post">
    	<div style="margin: 0pt; padding: 0pt;"></div>
    	<p><?php echo Yii::t('app', 'Reset Password'); ?></p>
    	<p><input value="" class="big" id="reset_email" name="email" type="text"></p>
    	<p class="btns"><input class="submit" id="submit" value="<?php echo Yii::t('app', 'email.password');?>" tabindex="3" type="submit"> <input class="reset"  value="<?php echo Yii::t('app', 'Reset');?>" tabindex="10" type="reset"></p>
    <div class="clear"></div>
    </form>
  </div>  
</div>
