    ...
    <div class="row">
            ...
            <br/>
             <?php foreach($attachments as $index=>$attachment) { 
                    ...
                    <?php echo $attachment->original_name;?>--<a href="/students/deleteFile/id/<?php echo $attachment->id;?>/appId/<?php echo $model->id;?>" onclick="return confirm('Are you sure?');">Delete File</a><br/><br/>                
                    <?php } } ?>
             <?php } ?>
    </div>
    <div class="row">
           ...
           <input type="file" id="photo" name="photo"/>
            ...
            <?php foreach($attachments as $index=>$attachment) {                         
                    ...
                    <img src="/<?php echo Yii::app()->params['ApplicationFilePath'].$attachment->attachment;?>" height="100px" width="100px"/>--<a href="/students/deleteFile/id/<?php echo $attachment->id;?>/appId/<?php echo $model->id;?>" onclick="return confirm('Are you sure?');">Delete File</a><br/>              
            <?php } } ?>
            <?php } ?>
    </div>
     <div class="row">
