...
/**
	...
	public static function getStudent($id)
	{
        ...
        {           
            ...
            if($batch)
            {
                $course = Course::getCourse($batch->course_id);
                return substr($batch->start_date,0,4)."-".substr($batch->end_date,0,4). " ( " . $course->name. " ) ";
            }
            return "N/A";
        }       
        
        public static function getActiveStudents($batch_id)
        {
            $criteria = new CDbCriteria;  
            $criteria->condition = "status ='".self::STATUS_ENABLED."' AND batch_id='".$batch_id."'";               
