...
class StudentSubjectMark extends CActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'student_id' => 'Student',
            'subject_id' => 'Subject',
            'mark' => "Ist exam's mark",
            'mark2' => "2nd exam's mark",
            'mark3' => 'Assignement Mark'
        );
    }
    ...
    public function isAlreadyExist($id = "")
    {
        ...
        if ($id)
            $condition = "id !=" . $id;
        $subjectResult = self::model()->findByAttributes(array('course_year_id' => $this->course_year_id,'semester_id' => $this->semester_id,'subject_id' => $this->subject_id, 'student_id' => $this->student_id), $condition);
        if ($subjectResult)
            return true;
        else
            return false;
    ...
    {
        return ($this->mark+$this->mark1+$this->mark2);
    }
